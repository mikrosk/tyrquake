...
SW_OBJS += nonintel.o r_surf68k.o r_sky68k.o r_misc68k.o r_alias68k.o r_aclip68k.o d_sprite68k.o d_sky68k.o d_part68k.o r_edge68k.o d_polyset68k.o r_draw68k.o r_bsp68k.o r_light68k.o d_edge68k.o #d_scan68k.o
else
SW_OBJS += nonintel.o
endif
...
else ifeq ($(IN_TARGET),atari)
CL_OBJS += in_atari.o keys_atari_asm.o
endif
